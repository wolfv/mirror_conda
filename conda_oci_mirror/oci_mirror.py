...
def get_github_packages(location, user_or_org, filter_function=None):
    ...
    print ("#################################################################################################")
    print ("username_or_orgname: " + username_or_orgname)
    print ("user_or_org: " + user_or_org)
    
    
    # api_url = f'https://api.github.com/orgs/{org}/packages'
    headers = {"accept": "application/vnd.github.v3+json"}
    if user_or_org == "user":
        api_url = f"https://api.github.com/user/{username_or_orgname}/packages"
...
if __name__ == "__main__":
    ...
    mirror(
        ["conda-forge"], subdirs_to_mirror, ["xtensor", "pip"], "user:MichaelKora", "ghcr.io"
    )
